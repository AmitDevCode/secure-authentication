...
import static com.skytel.security.google_security.constants.Permission.*;
...
//  MANAGER(Set.of(MANAGER_READ, MANAGER_UPDATE, MANAGER_DELETE, MANAGER_CREATE)),
  ...
  SYSTEM_ADMIN(Set.of(
          SYSTEM_ADMIN_READ, SYSTEM_ADMIN_UPDATE, SYSTEM_ADMIN_CREATE, SYSTEM_ADMIN_DELETE,
  ...
  MANAGER(Set.of(EMPLOYEE_READ, EMPLOYEE_UPDATE,  EMPLOYEE_CREATE, EMPLOYEE_DELETE)),
